...
Read `references/visual-design.md` when layout, typography, color, hierarchy, diagrams, or visual identity materially affects the artifact. Follow supplied authoritative templates first; otherwise offer the optional neutral example palette and record semantic roles and contrast evidence.
