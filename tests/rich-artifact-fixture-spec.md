...
- Visual system: supplied template if present; otherwise the optional semantic-role example palette, offered with its provenance stated, with recorded contrast pairs and non-color cues.
