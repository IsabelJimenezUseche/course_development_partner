...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| WS-1 | markdown |  |  |  | https://example.edu/ws-1 | student | LO-1 | teaching-ready | technical; alignment; accessibility; reopen | none | 2026-07-31 |  | https://example.edu/accessibility | not required | not applicable — no dataset |
